...
function Contact() {
    ...
    return (
         <div className="p-5 max-w-5xl mx-auto">
             <div  className="font-inter grid xs:grid-cols-1 sm:grid-cols-2 md:grid-cols-2 second-gradient-color justify-center rounded shadow-2xl">
                 <div id="contact" className="p-4 col-span-1">
                 <h1 className="bg-clip-text text-transparent text-yellow-500 text-2xl font-bold mb-6">{currentLanguage?.form?.[0]}</h1>
                 <form target="_blank" action="7588b525780fc1da38b4ef89858b3a41" method="POST">
                     ...
                     <div className="flex flex-col mb-4">
                         ...
                         <textarea style={{resize:'none'}} className="border py-2 px-3 text-grey-800" type="text" name="message" rows="1" id="message" required/>
                     </div>
                 ...
                 <img className="col-span-1 center m-auto items-center" src="/contact.jpg"/>         
             </div>
         </div>
    )
}
