...
import {Myprojects,greetings,intro} from '../data/english.json';
function Main() {
    ...
    return (
        ...
        <div className="flex flex-col w-2/3 m-auto p-0 md:flex-row rounded">
          <div className="font-inter flex justify-center flex-col font-bold b-1 leading-tight">
            <h1 className="text-5xl text-transparent bg-clip-text second-gradient-color">{greetings}</h1>  
            <p className="text-transparent bg-clip-text second-gradient-color text-2xl">{intro}</p>
          </div>
          <Animation/>
        </div>
