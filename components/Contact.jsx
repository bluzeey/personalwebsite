...
function Contact() {
    ...
    return (
            <div className="p-5 min-h-screen">
                <div className="font-inter grid xs:grid-cols-1 sm:grid-cols-1 md:grid-cols-2 min-h-screen second-gradient-color align-middle rounded shadow-2xl">
                    ...
                    <img className="col-span-1" src="/contact.jpg"/>         
                </div>
            </div>
    )
}
